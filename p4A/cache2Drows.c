...
/*
 * This function is used to measure the time it takes to access a 2D array elements in row-wise order.
 */
int main(void)
{
    // an inner loop iterate through the column of one row, outer loop iterate through the rows of the array
